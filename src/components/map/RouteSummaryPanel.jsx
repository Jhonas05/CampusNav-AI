...
export default function RouteSummaryPanel({
  ...
  return (
    <>
      <section className={`rounded-[1.5rem] border p-4 ${arrived ? "border-brand-800 bg-brand-800 text-white" : "border-[#E5E5E7] bg-white"}`}>
        ...
        <dl className={`mt-4 grid grid-cols-2 gap-x-3 gap-y-3 border-t pt-4 ${arrived ? "border-white/15" : "border-[#F0F0F2]"}`}>
          <div>
        ...
        <button
          ...
          className={`mt-4 inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-full border px-4 text-xs font-semibold transition-colors duration-200 ${
      ...
      <section className="rounded-[1.5rem] border border-[#E5E5E7] bg-white p-4">
